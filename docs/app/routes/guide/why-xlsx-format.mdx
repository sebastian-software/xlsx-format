...
¹ XLSM support covers workbook cell data and macro-free output containers. VBA projects are not read, preserved, or written. Do not use an XLSM read/write round trip when macros must survive unchanged.
...
Conditional formatting, data validation, charts, images, pivot tables, sparklines, VBA macros, custom theme XML, calculation-chain exposure, raw ZIP entry exposure, digital signatures, sheet/workbook protection, outline grouping.
